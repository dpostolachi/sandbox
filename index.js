...
const createState = (initialState) => {
    return ((subscribers) => {
        return new Proxy({
            ...initialState,
            subscribers,
            subscribe: (fragment, __fn) => subscribers.push({
                fragment,
                __fn
            }),
        }, {
...
const myTitle = observable(State)((createFragment, {
    title
}) => {
...
const myInput = observable(State)((createFragment, {
    title
}) => {
...
const myList = observable(State)((createFragment, {
    list
}) => {
    return createFragment('ul', {}, list.map((v, key) => {
